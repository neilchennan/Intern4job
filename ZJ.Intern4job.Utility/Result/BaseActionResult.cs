...
using ZJ.Intern4job.Utility.Result.Interface;

namespace ZJ.Intern4job.Utility.Result
{
    public class BaseActionResult : IActionResult<object, BaseActionResult>
    {
        ...
        public string Message
        {
            ...
            get
            {
                ...
                string joinedMessage = string.Join(Intern4jobConstants.SPLIT_SYMBOL_STR, messageList);
        ...
        public string Summary
        {
            get
            {
                string SummaryFormat = Intern4jobResources.MSG_TOTAL_RESULT_SUMMARY;
